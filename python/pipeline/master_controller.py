...
patient_id = "P00000"
segment_id = "s00"
file_total = patient_id.lower() + "_" + segment_id
file_name = os.path.join(
    datasets_dir, f"ECG_Data_{patient_id}", segment_id, file_total
...
def run_full_pipeline():
    ...
    print("=== STEP 2: Running batch processing ===")
    batch_test_main(
        file_name, output_csv_path=output_dir
    )  # This saves the batch processed outputs
    print("✅ Batch processing complete.\n")

    # === STEP 3: Stream data from MCU ===
    print("=== STEP 3: Running MCU streaming ===")
    print(
