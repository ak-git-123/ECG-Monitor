...
from python.pipeline.step2_flash_firmware_ble import main as generate_and_flash_firmware
...
# === PATHS =============================
STREAM_SCRIPT = os.path.join(os.path.dirname(__file__), "step4_stream_ble.py")
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "../.."))


# OUTPUT DIRECTORY FOR THIS RUN:
output_dir = os.path.join(
    project_root, "data_logs", "AD8232", data_file_name_base, "BLE"
)
